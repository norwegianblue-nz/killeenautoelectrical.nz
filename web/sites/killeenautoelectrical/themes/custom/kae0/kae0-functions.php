 ...
 * @return mixed
 */
function kae0_return_clean_breakpoint_id(\Drupal\breakpoint\Breakpoint $breakpoint) {
 ...
 */
function kae0_return_layouts($theme) {
 ...
 * @return int|string
 */
function kae0_find_layout_provider($theme) {
 ...
 */
function kae0_return_active_layout() {
  ...
  $layoutProvider = kae0_find_layout_provider($theme);
  //dpm($layoutProvider);
